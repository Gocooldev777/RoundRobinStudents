//values (total teams)document.writ
//definig the teams in the object

let totalTeams = { eachTeam: ["Team-1", "Team-2", "Team-3", "Team-4", "Team-5"] }
...
count = 0;
mainArr = [];
for (i = 0; i < teams.length; i = i + 2) {                  //running the loop for the each team schedule
    tempObj = {};
    dt = i;
